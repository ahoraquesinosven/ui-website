  ...
  <section name="important-sections" className="text-center mt-2 mt-md-5">
    <Row>
      <ImportantSectionColumn
        ...
        title="Femicidios en 2023"
        description="Registro de femicidios durante el año 2023, elaborado a partir del análisis de medios gráficos y digitales de todo el país."
        linkUrl="reports?category=registro-femicidios&category=informe-femicidios&fromDate=2023-01-01"
        alt="Informes y registros mensuales con los femicidios de 2023"
      />
      <ImportantSectionColumn
